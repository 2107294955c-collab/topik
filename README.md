...
- TOPIK II 51–54 题写作题库、分题/全科计时、本地草稿、改写历史，以及 OpenAI 结构化分项评分、中文错误档案和韩语修订版
...
- 最近七天学习统计、记忆复习状态、数据质量提示、逐题速度分析和真题/全科模考成绩历史
- 自动统计阅读题型正确率，并从进度页一键进入最弱题型训练
- v9 JSON 数据备份、导入、合并及旧版数据迁移（包含写作评分、语法测验、逐题用时、全科模考和题目收藏）
