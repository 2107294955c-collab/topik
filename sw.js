const CACHE='topik-study-shell-v8';
...
const CORE=['./','./index.html','./manifest.webmanifest','./assets/icon.svg','./assets/css/app.css?v=20260701-6','./assets/js/vocab-batch1.js?v=20260701-6','./assets/js/vocab-4000.js?v=20260701-6','./assets/js/grammar-400.js?v=20260701-6','./assets/js/topik-reading-bank.js?v=20260701-6','./assets/js/topik-listening-bank.js?v=20260701-6','./assets/js/data.js?v=20260701-6','./assets/js/storage.js?v=20260701-6','./assets/js/app.js?v=20260701-6',...QUESTION_IMAGES,...LISTENING_IMAGES];
