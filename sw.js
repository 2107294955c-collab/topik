const CACHE='topik-study-shell-v29';
...
const CORE=['./','./index.html','./manifest.webmanifest?v=20260715-1','./version.json','./assets/icon.svg','./assets/css/app.css?v=20260715-1','./assets/js/vocab-batch1.js?v=20260715-1','./assets/js/vocab-4000.js?v=20260715-1','./assets/js/grammar-400.js?v=20260715-1','./assets/js/topik-reading-bank.js?v=20260715-1','./assets/js/topik-listening-bank.js?v=20260715-1','./assets/js/data.js?v=20260715-1','./assets/js/storage.js?v=20260715-1','./assets/js/app.js?v=20260715-1',...QUESTION_IMAGES,...LISTENING_IMAGES];
...
self.addEventListener('fetch',event=>{
  ...
  if(url.pathname.endsWith('/version.json')){event.respondWith(fetch(request,{cache:'no-store'}).then(response=>{if(response.ok)caches.open(CACHE).then(cache=>cache.put('./version.json',response.clone()));return response}).catch(()=>caches.match('./version.json')));return}
